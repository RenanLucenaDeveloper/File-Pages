export default function initPresentation(){
  ...
  function initPagePlacement(pagesHTMLCollection) {
    ...
    pagesHTMLCollection[pagesHTMLCollection.length - 1].classList.add(
      "backward-pre-active"
    );
  }
  ...
  function initPageManipulation(pagesArray) {
    ...
    function moveForward() {
      ...
      if (
        ...
        document.querySelector(".backward-pre-active")
      ) {
        //retira o backward-pre-active do ultimo item
        pagesArray[pagesArray.length - 1].classList.remove(
          "backward-pre-active"
        );
      }
      ...
      if (
        activeElement + 2 !== pagesArray.length &&
        activeElement + 1 !== pagesArray.length
      ) {
    ...
    function moveBackward() {
      ...
      if (pagesArray[activeElement] == pagesArray[0]) {
        ...
        pagesArray[activeElement] == pagesArray[pagesArray.length - 1]
      ) {
